...
3. 时间：2026.9（研二上）→ 2027.7（实习）→ 2027 秋招
4. 每日可投入：3～4h；双线并行：Java 工程栈 + AI 大模型应用栈
5. 重要原则：学到一个知识点立刻编码练习，杜绝只看视频；所有学习最终汇聚到 2 个简历项目
## 整体时间总览
1. 第一阶段｜2026.09–2026.11（约 10 周）基础夯实：Java 补强 + Python 入门 + LLM 基础概念
2. 第二阶段｜2026.12–2027.02（寒假，3 个月）核心技术栈 + 简历项目 1：RAG 私有知识库
3. 第三阶段｜2027.03–2027.06（4 个月）Agent 进阶、工程化、实习投递、项目 2 迭代
4. 第四阶段｜2027.07–2027.11（实习 + 秋招）面试八股、项目深挖、持续投递广深岗位
